          ...
          child: Column(
            ...
            children: [
              ...
              _buildCourse(
                number: '1.',
                title: '커넬웨이 수변공원 (청라)',
                description: '청라호수공원에서 시작되는 인공수로를 따라 조성된 산책로와 자전거도로가 이어지는 코스로...',
                images: ['assets/images/img1.png', 'assets/images/img2.png'],
              ),
              _buildCourse(
                number: '2.',
                title: '인천대공원 -> 소래포구 -> 송도 달빛축제공원 코스',
                description: '약 20km의 코스로, 인천대공원에서 출발해 송산 자전거도로를 따라...',
              ),
              _buildCourse(
                number: '3.',
                title: '카페를 곁들인 산책 터널',
                description: '카페와 체험 공간이 함께 있는 산책로와 연결된 터널에서 즐길 수 있는 코스로...',
              ),
